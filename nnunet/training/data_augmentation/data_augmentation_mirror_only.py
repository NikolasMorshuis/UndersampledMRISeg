...
def get_mirror_augmentation(dataloader_train, dataloader_val, params=default_3D_augmentation_params,
    ...
    if params.get("do_mirror"):
        tr_transforms.append(MirrorTransform(params.get("mirror_axes"), p_per_sample=1))
