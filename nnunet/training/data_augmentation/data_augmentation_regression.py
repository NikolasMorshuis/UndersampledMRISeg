...
default_3D_augmentation_params = {
    ...
    "additive_brightness_p_per_sample": 0.,
    "additive_brightness_p_per_channel": 0.0,
    "additive_brightness_mu": 0.0,
    "additive_brightness_sigma": 0.0,
...
def get_data_augmentation_regression(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    tr_transforms.append(AppendChannelsTransform('data', 'target_reg', [1]))
    tr_transforms.append(RenameTransform('target_reg', 'target', True))
    ...
    val_transforms.append(AppendChannelsTransform('data', 'target_reg', [1]))
    val_transforms.append(RenameTransform('target_reg', 'target', True))
