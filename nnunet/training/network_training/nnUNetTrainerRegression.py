...
from nnunet.training.data_augmentation.data_augmentation_regression import (
    get_data_augmentation_regression,
)
...
class nnUNetTrainerRegression(nnUNetTrainerV2):
    """
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            self.loss = (
                torch.nn.MSELoss()
            )  # MultipleOutputLoss2(self.loss, self.ds_loss_weights)
            ################# END ###################
            ...
            if training:
                ...
                self.tr_gen, self.val_gen = get_data_augmentation_regression(
                    self.dl_tr,
                    self.dl_val,
    ...
    def process_plans(self, plans):
        ...
        self.num_classes = 1  # background is no longer in num_classes
    ...
    def validate(
        ...
        #
        print("We do not have a validation option for regression unets yet...")
    ...
    def setup_DA_params(self):
        ...
        self.data_aug_params["mask_was_used_for_normalization"] = (
            None  # self.use_mask_for_norm
        )
